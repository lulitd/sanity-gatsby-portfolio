      ...
      >
        <Container>
          <Box>
            ...
            >
              Hi my name is
              <Text as="span" pb={0} display="table" variant="title">
                {site.jumboName}.
              </Text>
            </Heading>
            <Heading fontWeight="400" display="table" fontSize={[3, 5]}>
              {site.jumboTag}
            </Heading>

            <Text pt={4} pb={2} display="table" fontSize={[1, 2, 3]} width={[1, 0.75, 0.6]}>
